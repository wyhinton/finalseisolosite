...
const vivekBio = `Vivek Menon is a classically trained violinist, and has worked with notable classical musicians such as Jennifer Koh, Donald Weilerstein, and members of the Kronos and Emerson string quartets. Vivek seeks to further the work of people of color, women, and gender non-conforming composers who face erasure and other barriers within the industry. He is disillusioned with the stoic and stagnant culture surrounding classical music, and is continually reimagining the experience of listening to a violin performance. Vivek’s violin arrangements on Lei Line Eon, the latest album by IGLOOGHOST, were described as "gorgeous" (Loud and Quiet Magazine), “haunting” (ourculture), and “eloquent and inviting…[lending] a bittersweet timelessness” (The Guardian). Vivek is currently pursuing a doctoral degree in violin performance at Stony Brook University, where he studies with Phil Setzer, Jennifer Frautschi, and Arnaud Sussmann.`;
