...
const Title = (): JSX.Element => {
  ...
  return (
    <FlexColumn>
      ...
      <img src={`${process.env.PUBLIC_URL}/SVG/LogoText.svg`}></img>
...
// <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="415.2px"
// 	 height="99.6px" viewBox="0 0 415.2 99.6" style="enable-background:new 0 0 415.2 99.6;" xml:space="preserve">
// <style type="text/css">
...
// </defs>
// <g>
// 	<path d="M47.5,0.5H35.8c-0.7,0-1.3,0.5-1.8,1.4c-0.5,1-0.8,2-0.8,3.2v2.3l-3.9-6.9H13.6L0.5,16.6v36.7l19.6,11.5h10.5
...
// 	<path d="M93.3,0.5H72.4l-3.9,4.2c-0.1-1-0.3-1.9-0.8-2.7c-0.5-1-1.1-1.4-1.8-1.4H55.4c-0.7,0-1.3,0.5-1.8,1.4
...
// 	<path  d="M122,0.5h-20.9c-0.7,0-1.3,0.5-1.8,1.4c-0.5,1-0.8,2-0.8,3.2V28c0,1.1,0.3,2.2,0.8,3.2c0.5,1,1.1,1.4,1.8,1.4
...
// 	<path  d="M174.3,0.5h-11.8c-0.7,0-1.3,0.5-1.8,1.4c-0.5,1-0.8,2-0.8,3.2v2.3L156,0.5h-15.7l-13.1,16.1v36.7l19.6,11.5
...
// 		z"/>
// 	<path d="M221.3,0.5H190l-10.5,18.4v75.7c0,1.1,0.3,2.2,0.8,3.2c0.5,1,1.1,1.4,1.8,1.4h31.4l10.5-18.4V5.1
// 		c0-1.1-0.3-2.2-0.8-3.2C222.6,1,222,0.5,221.3,0.5z M209.6,69.3H203l-1.3-9.2h-7.8V30.3h6.5l1.3,9.2h7.8V69.3z"/>
// 	<path d="M264.5,46.4H254l-10.5,18.4V46.4l5.3-9.3c0.4-0.8,0.8-1.6,0.9-2.4c0.2-0.8,0.3-1.9,0.3-3.1V5.1
...
// 		z"/>
// 	<path class="st0" d="M311.5,0.5h-31.4l-10.5,18.4v75.7c0,1.1,0.3,2.2,0.8,3.2c0.5,1,1.1,1.4,1.8,1.4h31.4l10.5-18.4V5.1
// 		c0-1.1-0.3-2.2-0.8-3.2C312.7,1,312.1,0.5,311.5,0.5z M299.7,69.3h-6.5l-1.3-9.2h-7.8V30.3h6.5l1.3,9.2h7.8V69.3z"/>
// 	<path class="st0" d="M335,69.3h-14.4c-0.7,0-1.3,0.5-1.8,1.4c-0.5,1-0.8,2-0.8,3.2v20.6c0,1.1,0.3,2.2,0.8,3.2
...
// 		z"/>
// 	<path class="st0" d="M365.1,0.5h-20.9c-0.7,0-1.3,0.5-1.8,1.4c-0.5,1-0.8,2-0.8,3.2V28c0,1.1,0.3,2.2,0.8,3.2
...
// 	<path class="st0" d="M413.9,1.9c-0.5-1-1.1-1.4-1.8-1.4h-31.4l-10.5,18.4v75.7c0,1.1,0.3,2.2,0.8,3.2c0.5,1,1.1,1.4,1.8,1.4h31.4
